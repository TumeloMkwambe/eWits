    ...
    <div className="DashboardContainer">
        ...
        <div className="ContentArea">
            <div id="payment-status">
                <div id="icon-holder">
                    <div id="status-icon-stripe" style={{backgroundColor: STATUS_CONTENT_MAP[status].iconColor}}>
                    ...
                    <div></div>
                    {intentId && <button href={`https://dashboard.stripe.com/payments/${intentId}`} id="view-details" rel="noopener noreferrer" target="_blank">View details
                    ...
                    <button  onClick={handleClick()}>Test another</button>
                </div>
        </div>
    </div>
