...
const LoadingAnimation = () => {
  return (
    <div className="spinner-container">
      <svg className="pl" viewBox="0 0 300 300" width="200" height="200" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="pl-grad1" x1="1" y1="0.5" x2="0" y2="0.5">
            <stop offset="0%" stopColor="hsl(313,90%,55%)" />
            <stop offset="100%" stopColor="hsl(223,90%,55%)" />
    ...
    <div className="DashboardContainer">
        ...
        <div className="ContentArea-stripe">
            <div id="payment-status">
                <div id="icon-holder">
                    <div id="status-icon-stripe" style={{backgroundColor: loading ? 'transparent' : STATUS_CONTENT_MAP[status].iconColor}}>
                        {loading ?  CircleLoad : (
                ...
                <h2 id="status-text-stripe">{STATUS_CONTENT_MAP[status].text}</h2>
                
                
                <button onClick={handleClick} id="button-stripe">Close</button>
